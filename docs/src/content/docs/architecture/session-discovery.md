...
The subsystem is composed of six modules, each handling a distinct concern. They layer on top of each other, with the `SessionDiscoveryService` orchestrating the rest.
